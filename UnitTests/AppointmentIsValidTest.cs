...
{
  [Fact]
  public void Negative_Doctor_Id_Returns_Error()
  {
    var appointment = new Appointment(0, -1, 0, DateTime.MinValue, DateTime.MaxValue);
  ...
  [Fact]
  public void Negative_Patient_Id_Returns_Error()
  {
    var appointment = new Appointment(0, 0, -1, DateTime.MinValue, DateTime.MaxValue);
    var check = appointment.IsValid();
  ...
  [Fact]
  public void EndTime_Less_Then_StartTime_Returns_Error()
  {
  ...
  [Fact]
  public void Valid_Appointment_Returns_Success()
  {
